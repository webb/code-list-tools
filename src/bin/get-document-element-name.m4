...
#HELP:COMMAND_NAME: get the qualified name of the document element of an XML document
...
vecho "input file is $1"

xalan --in="$1" --xsl="$share_dir"/get-document-element-name.xsl
